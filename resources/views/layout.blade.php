    ...
    <nav class = "navbar navbar-expand-lg navbar-light bg-light py-4 sticky-top z-3">
        <div class = "container">
            ...
            <a class = "navbar-brand d-flex justify-content-between align-items-center order-lg-0"
                ...
                <span class = "text-uppercase fw-lighter ms-2">Todo</span>
            </a>
            ...
            <div class = "collapse navbar-collapse order-lg-1" id = "navMenu">
                <ul class = "navbar-nav mx-auto text-center">
                    ...
                    <li class = "nav-item px-1 py-2 border-bottom border-danger me-1">
                        <a class = "nav-link text-uppercase text-dark" href = "{{ route('todos.index') }}">todos</a>
                    </li>
                    <li class = "nav-item px-1 py-2 border-bottom border-danger me-1">
                        <a class = "nav-link text-uppercase text-dark" href = "{{ route('todos.completed') }}">Completed</a>
                    </li>
                    <li class = "nav-item px-1 py-2 border-bottom border-danger me-1">
                        <a class = "nav-link text-uppercase text-dark" href = "{{ route('todos.daily') }}">Daily</a>
                    </li>
                </ul>
            </div>
        </div>
